...
villager() ->
    ...
    add_select_one(process_harvester, villager, [morale_normal, has_harvester], []),
        ...
        add_select_all(process_storage, process_harvester, [storage_needed], []),
    ...
    add_select_one(process_craft, villager, [morale_normal, has_craft], []),
        ...
        add_select_all(process_experiment, process_craft, [not_hauling, can_experiment], []),
