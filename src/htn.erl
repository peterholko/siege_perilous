...
villager() ->
    ...
    add_select_one(nearby_enemy, villager, [enemy_visible], []),
        add_select_all(flee_to_dwelling, nearby_enemy, [has_dwelling], []),
            ...
            add_primitive(move_to_dwelling1, flee_to_dwelling, [], [], move_to_pos),
        add_select_all(flee_to_hero, nearby_enemy, [hero_nearby], []),
            add_primitive(set_pos_hero1, flee_to_hero, [], [], set_pos_hero),
            add_primitive(move_to_hero1, flee_to_hero, [], [], move_to_pos),
    ...
    add_select_one(process_task, villager, [morale_normal], []),
        add_select_all(do_follow1, process_task, [order_follow], []),
            add_primitive(set_pos_hero2, do_follow1, [], [], set_pos_hero),
            add_primitive(move_to_hero2, do_follow1, [], [], move_to_pos),
        ...
        add_select_all(process_structure, process_task, [structure_needed], []),
            ...
            add_primitive(move_to_structure1, process_structure, [], [], move_to_pos),
            add_primitive(claim_structure, process_structure, [], [], claim_structure),
        add_select_all(process_harvest, process_task, [has_structure], []),
            add_primitive(set_pos_structure, process_harvest, [], [], set_pos_structure),
            add_primitive(move_to_structure2, process_harvest, [], [], move_to_pos),
