...
villager() ->
    ...
    add_select_one(tired, villager, [{has_effect, ?TIRED}, {has_effect, ?EXHAUSTED}], []),
        add_select_all(has_shelter, tired, [has_shelter], []),
            add_primitive(set_pos_shelter, has_shelter, [], [], set_pos_shelter),
            add_primitive(move_to_shelter, has_shelter, [], [], move_to_pos),
            add_primitive(sleep, has_shelter, [], [], sleep),
        add_select_all(no_shelter, tired, [], []),
            add_primitive(sleep, has_shelter, [], [], sleep),
