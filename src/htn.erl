...
villager() ->
    ...
    add_select_one(process_order, villager, [morale_normal, has_order], []),
        add_select_all(do_follow, process_task, [order_follow], []),
    ...
    %add_select_one(find_structure, villager, [morale_normal, structure_needed, free_structure], []),
    %    add_select_all(find_harvester, find_structure, [free_harvester], []),
    %        add_primitive(harvester, find_harvester, [], [], find_harvester),
    %        add_primitive(move_to_structure, find_harvester, [], [], move_to_pos),
    %    add_select_all(find_craft, find_structure, [free_craft], []),
    %        add_primitive(craft, find_craft, [], [], find_craft),
    ...
    add_select_one(process_craft, villager, [morale_normal, assigned_craft], []),
        add_select_all(refine, process_craft, [not_hauling, can_refine], []),
        ...
        add_select_all(craft, process_craft, [not_hauling, can_craft], []),
        ...
        add_select_all(experiment, process_craft, [not_hauling, can_experiment], []),
        ...
        add_select_all(craft_haul, process_craft, [has_resources], []),
            add_primitive(set_activity, craft_haul, [], [], set_hauling),
            add_primitive(set_pos_storage, craft_haul, [], [], set_pos_storage),
            add_primitive(move_to_storage, craft_haul, [], [], move_to_pos),
            add_primitive(transfer_item, craft_haul, [], [], load_resources),
            add_primitive(set_pos_structure, craft_haul, [], [], set_pos_structure),
            add_primitive(move_to_structure, craft_haul, [], [], move_to_pos),          
            add_primitive(transfer_item, craft_haul, [], [], unload_resources),            
            add_primitive(set_activity, craft_haul, [], [], set_none),
