...
villager() ->
    ...
    add_select_one(process_task, villager, [morale_normal], []),
        ...
        add_select_all(process_harvest, process_task, [has_structure, not_hauling, structure_not_full], []),
        ...
        add_select_all(process_storage, process_task, [storage_needed], []),
            add_primitive(find_storage, process_storage, [], [], find_storage),
        add_select_all(process_haul, process_task, [has_storage], []),
